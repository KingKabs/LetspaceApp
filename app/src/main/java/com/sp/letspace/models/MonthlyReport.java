...
public class MonthlyReport {
    ...
    public double getTotalRent() { return total_rent; }
    public double getCollectableRent() { return collectable_rent; }
    public int getVacantUnits() { return vacant_units; }
    public double getVacancyRate() { return vacancy_rate; }
    public double getOccupancyRate() { return occupancy_rate; }
}
